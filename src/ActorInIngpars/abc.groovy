...
Coordinator actor and two FRomGparsOfficial.Player actors. The Coordinator sends a play message to both Players and then waits to receive
a response. After it has received two responses, the Coordinator prints the outcome of the match and sends a message to
itself to start a new game. The FRomGparsOfficial.Player actors wait to be asked for a move, whereupon each one responds with an arbitrary
move.
 */
